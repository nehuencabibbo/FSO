...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, equals the amount of likes of the list', () => {
...
describe('favorite blog', () => {
  ...
  test('of list with one blog is that blog', () => {
    ...
    assert.deepStrictEqual(favBlog, expectedFavBlog)
  })
...
describe('most blogs', () => {
  ...
  test('of list with one blog is that blog', () => {
    ...
    assert.deepStrictEqual(mostBlogs, expectedMostBlogs)
  })
  ...
  test('of list with multiple blogs is the author with the most blogs', () => {
...
describe('most likes', () => {
  ...
  test('of list with one blog is that blog', () => {
    ...
    assert.deepStrictEqual(mostLikes, expectedMostLikes)
  })
  ...
  test('of list with multiple blogs is the author with the most likes', () => {
